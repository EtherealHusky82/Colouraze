...
levels.no_ofshapes = { circles = 5, wall_arrangement_types = 5, portals = 2, exit_sensor = 1 }
...
levels.shapeDetails = { circle_radius = 0.15*wall_width,  scale = 1, 
						...
						{ 
							...
							{ x=startPointX, y=4*wall_width },
							{ x=startPointX + wall_width - wall_height, y=6*wall_width },				
							{ x=startPointX + wall_width + wall_height, y=6*wall_width }
						},
						
						circle_colours = { {0.961,0.639,0}, {0.345,0.812,0}, {0,0.345,0.812}, {0.961,0.639,0}, {0.345,0.812,0} },

						no_of_groups_for_each_arrangement = {7,1,2,1,1}, no_of_walls_in_arrangement = {4,3,3,1,6},
						...
						wall_rotations = { {0,90,180,270}, {0,90,270}, {90,180,270}, {90}, {0,0,0,90,180,270} }, 

						wall_group_coordinates = { 	{ x=startPointX + 2*wall_width, y=2*wall_width }, 
											 	   	{ x=startPointX + 3*wall_width, y=2*wall_width }, 
						...
						wall_colours = { { {0.467,0,0.812}, {0.345,0.812,0}, {0.467,0,0.812}, {0.467,0,0.812} }, 
										 { {0.467,0,0.812}, {0.467,0,0.812}, {0.961,0.639,0}, {0,0.345,0.812} },																	 
										 { {0.345,0.812,0}, {0.467,0,0.812}, {0,0.345,0.812}, {0.467,0,0.812} },																	 
										 { {0.961,0.639,0}, {0.467,0,0.812}, {0.467,0,0.812}, {0.467,0,0.812} },
										 { {0.467,0,0.812}, {0.467,0,0.812}, {0.961,0.639,0}, {0.467,0,0.812} },
										 { {0.467,0,0.812}, {0,0.345,0.812}, {0.467,0,0.812}, {0.467,0,0.812} },
										 { {0,0.345,0.812}, {0.961,0.639,0}, {0.467,0,0.812}, {0.961,0.639,0} },
										 { {0.345,0.812,0}, {0.467,0,0.812}, {0.467,0,0.812}				  },
										 { {0.467,0,0.812}, {0.467,0,0.812}, {0,0.345,0.812}  				  },
										 { {0.467,0,0.812}, {0.961,0.639,0}, {0.467,0,0.812}  				  },
										 { {0.467,0,0.812} 													  }, 
										 { {0.345,0.812,0}, {0,0.345,0.812}, {0,0.345,0.812}, {0.467,0,0.812}, {0.467,0,0.812}, {0.467,0,0.812} }										 
										
									   },						
						
						portal_coordinates = { { x=startPointX, y=3*wall_width }, 
											   { x=startPointX + 2*wall_width, y=4*wall_width } 
											 },

						exit_coordinates = { { x=startPointX, y=1.5*wall_width } }
...
levels.laserTrapDetails = { no_of_traps = 1, no_of_lasers_per_trap = 2, intervaltimer = 2000, 
							lasers_location = { {x=startPointX + 2.5*wall_width, y=3.5*wall_width}, {x=startPointX + 3.4*wall_width,y=4.5*wall_width} },
							lasers_direction = { 90, -90 }, distanceBetweenWalls = wall_width 
						  } 
						  
levels.isthereGuideText = true
levels.guideText = { {text='Did I mention white lasers? It destroys circles that it hits! avoid them!'} }						  
