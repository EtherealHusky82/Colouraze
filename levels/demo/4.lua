...
levels.shapeDetails = { circle_radius = 0.15*wall_width,  scale = 1, 
						...
						portal_coordinates = { { x=startPointX + 2*wall_width, y=4*wall_width }, 
											   { x=startPointX, y=5*wall_width } 
											 },

						exit_coordinates = { { x=startPointX, y=1.4*wall_width } }
...
levels.spikesDetails = { no_of_spikes = 3, spikes_location = { {x=startPointX-0.3*wall_width, y=1.8*wall_width}, {x=startPointX+0.3*wall_width, y=2.3*wall_width}, 
						 {x=startPointX-(0.3*wall_width), y=2.8*wall_width} }, spikes_direction = { 0, 180, 0 } 
					   }

levels.isthereGuideText = true
levels.guideText = { {text='Oh and there are red coloured nasty spikes too!'} }
